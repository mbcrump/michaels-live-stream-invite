...
// Get request body
    ...
    var icalevent = new Event()
        {
            DtStart = new CalDateTime(new DateTime(nextStreamDay.Year, nextStreamDay.Month, nextStreamDay.Day, starthour, 0, 0, DateTimeKind.Local)),
             DtEnd = new CalDateTime(new DateTime(nextStreamDay.Year, nextStreamDay.Month, nextStreamDay.Day, stophour, stopminute, 0, DateTimeKind.Local)),
   ...
   public static DateTime GetNextWeekday(DateTime start, DayOfWeek day)
   {
      ...
      return start.AddDays(daysToAdd).ToUniversalTime();
   }
